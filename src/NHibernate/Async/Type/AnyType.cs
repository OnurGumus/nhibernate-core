...
namespace NHibernate.Type
{
	...
	public partial class AnyType : AbstractType, IAbstractComponentType, IAssociationType
	{
		...
		public async Task<object[]> GetPropertyValuesAsync(Object component, EntityMode entityMode)
		{
		...
		{
			await (NullSafeSetAsync(st, value, index, null, session));
		}
		...
		{
			return entityName == null || id == null ? null : await (session.InternalLoadAsync(entityName, id, false, false));
		}
	}
}