...
namespace NHibernate.Loader.Criteria
{
	...
	public partial class CriteriaQueryTranslator : ICriteriaQuery
	{
		...
		public async Task<SqlString> GetSelectAsync(IDictionary<string, IFilter> enabledFilters)
		{
			return await (rootCriteria.Projection.ToSqlStringAsync(rootCriteria.ProjectionCriteria, 0, this, enabledFilters));
		}
