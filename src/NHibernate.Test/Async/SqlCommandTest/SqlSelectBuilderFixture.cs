...
namespace NHibernate.Test.SqlCommandTest
{
	...
	public partial class SqlSelectBuilderFixtureAsync
	{
		[Test]
		public void SelectStringSqlTest()
		{
			...
			select.SetOuterJoins(new SqlString(" LEFT OUTER JOIN before ON select_test_alias.column1 = before.column1"), new SqlString(" after.some_field = after.another_field "));
