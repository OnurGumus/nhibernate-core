...
namespace NHibernate.Test.NHSpecificTest.NH2583
{
	...
	public partial class MassTestingSelectFixture : AbstractMassTestingFixture
	{
		// Condition pattern: (A && B) && (C || D) SELECT E
		[Test]
		public async Task Test_xyP_in_E____xy_OJAsync()
		{
		...
		[Test]
		public async Task Test_xy_in_A__xyP_in_E____xy_OJAsync()
		{
		...
		[Test]
		public async Task Test_xyP_in_A__xyP_in_E____xy_IJAsync()
		{
		...
		[Test]
		public async Task Test_xyP_in_A_C_E____xy_IJAsync()
		{
		...
		[Test]
		public async Task Test_xyP_in_A_C_D_E____xy_IJAsync()
		{
		...
		[Test]
		public async Task Test_xyP_in_C_D_E____xy_IJAsync()
		{
		...
		[Test]
		public async Task Test_xyP_in_C_E____xy_OJAsync()
		{
