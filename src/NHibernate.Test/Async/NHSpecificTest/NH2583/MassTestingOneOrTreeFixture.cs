...
namespace NHibernate.Test.NHSpecificTest.NH2583
{
	...
	public partial class MassTestingOneOrTreeFixtureAsync : AbstractMassTestingFixtureAsync
	{
		...
		{
			await (RunTestAsync(x => (x.K1 == 1 && x.K2 == 1) && ((x.BO1.I1 == 1 && x.BO2.J1 == 1) || (x.BO1.I2 == 1 && x.BO2.J2 == 1)), Setters<TK, TK, TBO1_I, TBO2_J, TBO1_I, TBO2_J>(MyBO.SetK1, MyBO.SetK2, MyBO.SetBO1_I1, MyBO.SetBO2_J1, MyBO.SetBO1_I2, MyBO.SetBO2_J2)));
		}
