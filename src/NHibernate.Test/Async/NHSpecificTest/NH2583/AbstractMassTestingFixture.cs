...
namespace NHibernate.Test.NHSpecificTest.NH2583
{
	...
	public abstract partial class AbstractMassTestingFixtureAsync : BugTestCaseAsync
	{
						...
						foreach (T4 v4 in Enum.GetValues(typeof (T4)))
						{
							foreach (T5 v5 in Enum.GetValues(typeof (T5)))
							{
								foreach (T6 v6 in Enum.GetValues(typeof (T6)))
								{
									...
									{
										yield return new ValueTuple<T1, T2, T3, T4, T5, T6, T7>{Item1 = v1, Item2 = v2, Item3 = v3, Item4 = v4, Item5 = v5, Item6 = v6, Item7 = v7};
									}
								}
							}
						}
		...
		public partial class SetterTuple<T1, T2, T3, T4, T5, T6, T7>
		{
			...
			public SetterTuple(Action<MyBO, ISession, T1> set1, Action<MyBO, ISession, T2> set2, Action<MyBO, ISession, T3> set3, Action<MyBO, ISession, T4> set4, Action<MyBO, ISession, T5> set5, Action<MyBO, ISession, T6> set6, Action<MyBO, ISession, T7> set7)
			{
				_set1 = set1;
				_set2 = set2;
				_set3 = set3;
		...
		protected static SetterTuple<T1, T2, T3, T4, T5, T6, Ignore> Setters<T1, T2, T3, T4, T5, T6>(Action<MyBO, ISession, T1> set1, Action<MyBO, ISession, T2> set2, Action<MyBO, ISession, T3> set3, Action<MyBO, ISession, T4> set4, Action<MyBO, ISession, T5> set5, Action<MyBO, ISession, T6> set6)
		{
			return new SetterTuple<T1, T2, T3, T4, T5, T6, Ignore>(set1, set2, set3, set4, set5, set6, null);
		}

		protected static SetterTuple<T1, T2, T3, T4, T5, Ignore, Ignore> Setters<T1, T2, T3, T4, T5>(Action<MyBO, ISession, T1> set1, Action<MyBO, ISession, T2> set2, Action<MyBO, ISession, T3> set3, Action<MyBO, ISession, T4> set4, Action<MyBO, ISession, T5> set5)
		{
			return new SetterTuple<T1, T2, T3, T4, T5, Ignore, Ignore>(set1, set2, set3, set4, set5, null, null);
		}

		protected static SetterTuple<T1, T2, T3, T4, Ignore, Ignore, Ignore> Setters<T1, T2, T3, T4>(Action<MyBO, ISession, T1> set1, Action<MyBO, ISession, T2> set2, Action<MyBO, ISession, T3> set3, Action<MyBO, ISession, T4> set4)
		{
			return new SetterTuple<T1, T2, T3, T4, Ignore, Ignore, Ignore>(set1, set2, set3, set4, null, null, null);
		}

		protected static SetterTuple<T1, T2, T3, Ignore, Ignore, Ignore, Ignore> Setters<T1, T2, T3>(Action<MyBO, ISession, T1> set1, Action<MyBO, ISession, T2> set2, Action<MyBO, ISession, T3> set3)
		{
			return new SetterTuple<T1, T2, T3, Ignore, Ignore, Ignore, Ignore>(set1, set2, set3, null, null, null, null);
		}

		protected static SetterTuple<T1, T2, Ignore, Ignore, Ignore, Ignore, Ignore> Setters<T1, T2>(Action<MyBO, ISession, T1> set1, Action<MyBO, ISession, T2> set2)
		{
