...
namespace NHibernate.Test.Stateless
{
	...
	public partial class StatelessSessionFixture : TestCase
	{
		...
		[Test]
		public Task HavingDetachedCriteriaThenCanGetExecutableCriteriaFromStatelessSessionAsync()
		{
			try
			{
				HavingDetachedCriteriaThenCanGetExecutableCriteriaFromStatelessSession();
