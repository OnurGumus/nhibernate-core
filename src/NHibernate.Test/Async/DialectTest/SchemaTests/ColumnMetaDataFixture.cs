...
namespace NHibernate.Test.DialectTest.SchemaTests
{
	...
	public partial class ColumnMetaDataFixtureAsync
	{
		[System.CodeDom.Compiler.GeneratedCode("AsyncGenerator", "1.0.0")]
		private class TestableColumnMetaData : AbstractColumnMetaData
		{
			public TestableColumnMetaData(DataRow rs, object columnSizeValue, object numericalPrecisionValue): base (rs)
			{
		...
		public void SetColumnSizeAndNumericalPrecision(object columnSizeInput, object precisionInput, int expectedColumnSize, int expectedPrecision)
		{
