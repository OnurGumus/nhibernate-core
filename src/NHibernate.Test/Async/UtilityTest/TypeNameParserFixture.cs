...
namespace NHibernate.Test.UtilityTest
{
	...
	public partial class TypeNameParserFixtureAsync
	{
		...
		public Task ParseUnmatchedBracketAsync()
		{
			try
			{
		...
		[Test]
		public Task ParseInvalidEscapeAsync()
		{
			try
			{
		...
		public void NH1822()
		{
			var typeName = @"OldMutual.SalesGear.Data.ReferenceType`2[ 
