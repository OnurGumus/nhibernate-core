...
namespace NHibernate.Test.UtilityTest
{
	...
	public partial class StringHelperFixtureAsync
	{
		[Test]
		...
		/// </summary>
		[Test]
		public Task CantCountQuotesAsync()
		{
			try
			{
		...
		[TestCase("a\nb", 0, 1, 1)]
		[TestCase("ab\r\nfoo\r\n", 4, 7, 2)]
		public void IndexOfAnyNewLineReturnsIndexAndLength(string str, int startIndex, int expectedIndex, int expectedMatchLength)
		{
			int matchLength;
		...
		[TestCase("a\nb", 1, true, 1)]
		[TestCase("a\r\nb", 1, true, 2)]
		public void IsAnyNewLineMatchAndLength(string str, int startIndex, bool expectNewLine, int expectedMatchLength)
		{
			int matchLength;
