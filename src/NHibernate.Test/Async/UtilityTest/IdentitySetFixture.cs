...
namespace NHibernate.Test.UtilityTest
{
	...
	public partial class IdentitySetFixtureAsync
	{
		...
		/// </summary>
		[Test]
		public Task AddValueTypeExceptionAsync()
		{
			try
			{
				ISet<object> set = GetIdentitySet();
		...
		public void ContainsSameObjectByRef()
		{
			...
			Assert.IsTrue(set.Contains(item1Copy), "We should be able to get the same object out of the IdentitySet with " + "two different references to the same object.");
		}
