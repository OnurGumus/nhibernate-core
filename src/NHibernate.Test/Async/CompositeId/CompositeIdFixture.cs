...
namespace NHibernate.Test.CompositeId
{
	...
	public partial class CompositeIdFixtureAsync : TestCaseAsync
	{
		...
		public async Task MultipleCollectionFetchAsync()
		{
			...
			s = OpenSession();
			t = s.BeginTransaction();
			c = (Customer)await (s.CreateQuery("from Customer c left join fetch c.Orders o left join fetch o.LineItems li left join fetch li.Product p").UniqueResultAsync());
