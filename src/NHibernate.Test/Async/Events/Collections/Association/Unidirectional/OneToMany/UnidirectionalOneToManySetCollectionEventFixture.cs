...
namespace NHibernate.Test.Events.Collections.Association.Unidirectional.OneToMany
{
	...
	public partial class UnidirectionalOneToManySetCollectionEventFixtureAsync : AbstractAssociationCollectionEventFixtureAsync
	{
		protected override IList Mappings
		{
			get
			{
				return new string[]{"Events.Collections.Association.Unidirectional.OneToMany.UnidirectionalOneToManySetMapping.hbm.xml"};
			}
		}
