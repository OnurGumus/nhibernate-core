...
namespace NHibernate.Test.QueryTest
{
	...
	public partial class MultipleQueriesFixtureAsync : TestCaseAsync
	{
		...
		public async Task NH_1085_WillGiveReasonableErrorIfBadParameterNameAsync()
		{
			using (var s = sessions.OpenSession())
			{
				var multiQuery = s.CreateMultiQuery().Add("from Item i where i.Id in (:ids)").Add("from Item i where i.Id in (:ids2)");
