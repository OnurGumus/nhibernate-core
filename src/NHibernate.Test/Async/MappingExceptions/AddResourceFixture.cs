...
namespace NHibernate.Test.MappingExceptions
{
	...
	public partial class AddResourceFixtureAsync
	{
		[Test]
		...
		public void AddDuplicateImport()
		{
			...
			catch (MappingException me)
			{
				...
				string expected = string.Format("duplicate import: A refers to both NHibernate.Test.MappingExceptions.A, {0} and Some other class (try using auto-import=\"false\")", Assembly.GetExecutingAssembly().FullName);
