	...
	public partial class MapFixtureAsync
	{
		...
		public void TestMapElementElement()
		{
			...
			mapper.Class<ClassWithMapElementElement>(c =>
			{
				...
				, key => key.Element(e => e.Column("key")), element => element.Element(e => e.Column("element")));
			}
		...
		public void TestMapEntityEntity()
		{
			...
			mapper.Class<ClassWithMapEntityEntity>(c =>
			{
				...
				, key => key.ManyToMany(e => e.Column("key")), element => element.ManyToMany(e => e.Column("element")));
			}
		...
		public void TestMapEntityElement()
		{
			...
			mapper.Class<ClassWithMapEntityElement>(c =>
			{
				...
				, key => key.ManyToMany(e => e.Column("key")), element => element.Element(e => e.Column("element")));
			}
		...
		public void TestMapElementEntity()
		{
			...
			mapper.Class<ClassWithMapElementEntity>(c =>
			{
				...
				, key => key.Element(e => e.Column("key")), element => element.ManyToMany(e => e.Column("element")));
			}
		...
		public void TestMapEntityComponent()
		{
			...
			mapper.Class<ClassWithMapEntityComponent>(c =>
			{
				...
				, key => key.ManyToMany(e => e.Column("key")), element => element.Component(cmp => cmp.Class<Component>()));
			}
		...
		public void TestMapElementComponent()
		{
			...
			mapper.Class<ClassWithMapElementComponent>(c =>
			{
				...
				, key => key.Element(e => e.Column("key")), element => element.Component(cmp => cmp.Class<Component>()));
			}
