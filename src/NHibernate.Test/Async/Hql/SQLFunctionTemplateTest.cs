...
namespace NHibernate.Test.Hql
{
	...
	public partial class SQLFunctionTemplateTestAsync : BaseFunctionFixture
	{
		[Test]
		public void Simple()
		{
		...
		public void NoStringArguments()
		{
			...
			string expected = string.Format("{0} {1} {2}", DateTime.Today.ToString(DateTimeFormatInfo.InvariantInfo), (125.6D).ToString(NumberFormatInfo.InvariantInfo), (0910.123456m).ToString(NumberFormatInfo.InvariantInfo));
