...
namespace NHibernate.Test.Hql.Ast
{
	...
	{
		[Test]
		public Task DeleteNonExistentEntityAsync()
		{
			try
			{
		...
		[Test]
		public Task UpdateNonExistentEntityAsync()
		{
			try
			{
		...
		[Test]
		public Task WrongPropertyNameThrowQueryExceptionAsync()
		{
			try
			{
				WrongPropertyNameThrowQueryException();
				return TaskHelper.CompletedTask;
			}
			catch (Exception ex)
			{
