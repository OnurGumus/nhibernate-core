...
namespace NHibernate.Test.CfgTest
{
	...
	public partial class ConfigurationSchemaFixtureAsync
	{
		[Test]
		public Task InvalidConfigAsync()
		{
			try
			{
...
<hibernate-configuration xmlns='urn:nhibernate-configuration-2.2'>
		...
		[Test]
		public Task EmptyFactoryNotAllowedAsync()
		{
			try
			{
...
<hibernate-configuration xmlns='urn:nhibernate-configuration-2.2'>
	<session-factory>
		...
		public void MappingEquatable()
		{
			...
			Assert.IsTrue((new MappingConfiguration("AAssembly", null)).Equals((new MappingConfiguration("AAssembly", "SomeResource"))), "Whole assembly is not equal then partial assembly.");
			// Two different partial assembly are not equals
			Assert.IsFalse((new MappingConfiguration("AAssembly", "AnotherResource")).Equals((new MappingConfiguration("AAssembly", "SomeResource"))));
			Assert.IsTrue((new MappingConfiguration("AAssembly", "")).Equals((new MappingConfiguration("AAssembly", null))));
			Assert.IsTrue((new MappingConfiguration("AAssembly", "aResource")).Equals((new MappingConfiguration("AAssembly", "aResource"))));
		...
		[Test]
		public Task NotAllowedMappingsAsync()
		{
			try
			{
				string xml = @"<?xml version='1.0' encoding='utf-8' ?>
