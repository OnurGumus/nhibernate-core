...
namespace NHibernate.Test.IdGen.Enhanced.Sequence
{
	...
	public partial class DefaultOptimizedSequenceTestAsync : TestCaseAsync
	{
		private readonly bool _preferLo;
		private readonly System.Type _expectedOptimizerType;
		public DefaultOptimizedSequenceTestAsync(bool preferLo, System.Type expectedOptimizerType)
		{
			_preferLo = preferLo;
		...
		protected override IList Mappings
		{
			get
			{
				return new[]{"IdGen.Enhanced.Sequence.DefaultOptimized.hbm.xml"};
			}
		}
