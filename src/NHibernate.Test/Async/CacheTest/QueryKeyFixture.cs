...
namespace NHibernate.Test.CacheTest
{
	...
	public partial class QueryKeyFixtureAsync : TestCaseAsync
	{
		private readonly SqlString SqlAll = new SqlString("select entitywith0_.id as id0_, entitywith0_.Description as Descript2_0_, entitywith0_.Value as Value0_ from EntityWithFilters entitywith0_");
		...
		protected override IList Mappings
		{
			get
			{
				return new[]{"CacheTest.EntityWithFilters.xml"};
			}
		}
