	...
	public partial class SelectionTestsAsync : LinqTestCaseAsync
	{
		...
		public void CanSelectWithAggregateSubQuery()
		{
			var timesheets = (
				...
				select new
				{
				timesheet.Id, EntryCount = timesheet.Entries.Count
				}
		...
		[Test]
		public Task CanSelectFirstElementFromChildCollectionAsync()
		{
			try
			{
				Assert.Throws<AssertionException>(() =>
				{
					...
					{
						var orders = db.Customers.Select(customer => customer.Orders.OrderByDescending(x => x.OrderDate).First()).ToList();
		...
		public void CanProjectWithCast()
		{
			...
			var names1 = db.Users.Select(p => new
			{
			p1 = p.Name
			}
			...
			var names2 = db.Users.Select(p => new
			{
			p1 = ((User)p).Name
			}
			...
			var names3 = db.Users.Select(p => new
			{
			p1 = (p as User).Name
			}
			...
			var names4 = db.Users.Select(p => new
			{
			p1 = ((IUser)p).Name
			}
			...
			var names5 = db.Users.Select(p => new
			{
			p1 = (p as IUser).Name
			}
		...
		{
			var moreThanTwoOrderLinesBool = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNBool = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesShort = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNShort = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesInt = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNInt = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesDecimal = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNDecimal = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesSingle = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNSingle = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesDouble = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNDouble = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesString = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesDateTime = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNDateTime = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesGuid = db.Orders.Select(o => new
			{
			...
			var moreThanTwoOrderLinesNGuid = db.Orders.Select(o => new
			{
		...
		{
			var fatherIsKnown = db.Animals.Select(a => new
			{
